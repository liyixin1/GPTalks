...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        self.ComboBox_2 = QtWidgets.QComboBox(parent=self.tab_display)
        ...
        self.ComboBox_2.addItem("")
        self.ComboBox_2.addItem("")
        self.formLayout_display.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.ComboBox_2)
    ...
    def retranslateUi(self, settings_dialog):
        ...
        self.ComboBox_2.setItemText(0, _translate("settings_dialog", "10"))
        self.ComboBox_2.setItemText(1, _translate("settings_dialog", "11"))
        self.ComboBox_2.setItemText(2, _translate("settings_dialog", "12"))
        self.ComboBox_2.setItemText(3, _translate("settings_dialog", "13"))
        self.ComboBox_2.setItemText(4, _translate("settings_dialog", "14"))
        self.ComboBox_2.setItemText(5, _translate("settings_dialog", "15"))
        self.ComboBox_2.setItemText(6, _translate("settings_dialog", "16"))
        self.ComboBox_2.setItemText(7, _translate("settings_dialog", "17"))
        self.ComboBox_2.setItemText(8, _translate("settings_dialog", "18"))
        self.ComboBox_2.setItemText(9, _translate("settings_dialog", "19"))
        self.ComboBox_2.setItemText(10, _translate("settings_dialog", "20"))
        self.Label_theme.setText(_translate("settings_dialog", "主题"))
        self.ComboBox_theme.setItemText(0, _translate("settings_dialog", "Light Mode"))
        self.ComboBox_theme.setItemText(1, _translate("settings_dialog", "Dark Mode"))
